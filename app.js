...
wss.on('connection', (ws) => {
    ...
    setInterval(() => {
        const temperature = Math.floor(Math.random() * 100); // Simulated temperature data
        const voltage = Math.floor(Math.random() * 10); // Simulated voltage data
        const distance = Math.floor(Math.random() * 50); // Simulated distance data
...
app.post('/data', (req, res) => {
    ...
    console.log("req");
    // const { temperature, voltage, distance } = req.body; // Destructure data from the request body
    // console.log(`Received data - Temperature: ${temperature}, Voltage: ${voltage}, Distance: ${distance}`);
